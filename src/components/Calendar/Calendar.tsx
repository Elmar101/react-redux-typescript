...
import { createDateKey } from '../../libs/util/util';
import { RootState } from '../../redux/store';
import { loadUserEventsFn, selectUserEventsArray, UserEvent } from '../../redux/user-events';
import './Calendar.css';
...
const Calendar: React.FC<Props> = ({ events, loadUserEventsFn }) => {
  useEffect(() => {
    loadUserEventsFn();
  }, []);
